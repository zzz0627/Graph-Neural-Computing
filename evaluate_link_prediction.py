...
if __name__ == "__main__":
    ...
    if args.model_name == 'EdgeBank':
        ...
        for run in range(args.num_runs):
            ...
            args.seed = run
            args.load_model_name = f'{args.model_name}_{args.feature_tag}_seed{args.seed}'
            args.save_result_name = f'{args.negative_sample_strategy}_negative_sampling_{args.model_name}_{args.feature_tag}_seed{args.seed}'
